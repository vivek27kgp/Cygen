...
const Viewpage: React.FC = () => {
  ...
  const [categoryData, setCategoryData] = useState<any>(null); // State to Purchase category data
  ...
  const outlet_id = localStorage.getItem('outlet_id');
    ...
    useEffect(() => {
    fetchData('/getPurchasesList/'+outlet_id, setCategoryData, setError, setIsLoading);
  ...
  <div className="flex flex-wrap sm:flex-nowrap justify-between items-center ">
                ...
                <NavLink to="/addpurchase" className="inline-flex items-center justify-center rounded-md border border-primary py-2 px-5 text-center font-medium text-primary hover:bg-opacity-90 lg:px-8 xl:px-10 mr-4 mb-2" onClick={togglePopup}>
  ...
  <div className="sm:flex">
    {/* <a onClick={togglePopup} className="inline-flex items-center justify-center rounded-md border border-primary py-2 px-5 text-center font-medium text-primary hover:bg-opacity-90 lg:px-8 xl:px-10 mb-2">
      ...
      <span className="text-sm">Purchase Filter</span>
    </a> */}
  </div>
</div>
  ...
  <thead className="bg-gray-50">
    <tr>
      ...
      <p className="ttext-center items-center">Order Id</p> 
      </th>
      <th className="px-6 py-2 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500">
      <p className="ttext-center items-center">Ref Number</p> 
      </th>
      <th className="px-6 py-2 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
        Date   
      </th>
      <th className="px-6 py-2 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
      <p className="ttext-center items-center">Amount</p>  
      </th>
      <th className="px-6 py-2 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
      <p className="ttext-center items-center">Supplier</p>  
      </th>
    ...
    {categoryData && categoryData.list && categoryData.list.map((category: any) => (
      ...
      <tr key={category.id} className="whitespace-nowrap"> 
        <td className="px-6 py-4 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
         ...
         <div className="flex flex-col gap-4 sm:flex-row sm:items-center items-center"><p className="text-sm text-black dark:text-white text-center">{category.id}</p></div>
        </td>
     
        <td className="px-6 py-4 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
        
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center items-center"><p className="text-sm text-black dark:text-white text-center">{category.reference_no}</p></div>
       </td>
        <td className="px-6 py-4 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
        
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center items-center"><p className="text-sm text-black dark:text-white text-center">{category.purchase_date}</p></div>
       </td>
       <td className="px-6 py-4 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
        
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center items-center"><p className="text-sm text-black dark:text-white text-center">{category.grand_total}</p></div>
       </td>
       <td className="px-6 py-4 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
        
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center items-center"><p className="text-sm text-black dark:text-white text-center">{category.supplier_id}</p></div>
       </td>
       <td className="px-6 py-4 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
        
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center items-center"><p className="text-sm text-black dark:text-white text-center">{category.purchase_status}</p></div>
       </td>
