...
const SelectGroupOne: React.FC<SelectGroupOneProps> = ({ categoryType }) => {
  ...
  return (
    <div className="w-full xl:w-1/3 mb-1">
      ...
      <div className="relative z-20 bg-transparent dark:bg-form-input fotnlabel">
        <select
        ...
        >
          <option value="" disabled className="text-body dark:text-bodydark fotnlabel">
            Select  {categoryType}
          </option>
          <option value="Grocery" className="text-body dark:text-bodydark fotnlabel">
            Grocery
          </option>
          <option value="Rice" className="text-body dark:text-bodydark fotnlabel" >
            Rice
          </option>
        </select>
