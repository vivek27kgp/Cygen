...
const Viewpageexpired: React.FC = () => {
 ...
 function showCheckbox(showColumnToggles: boolean){
  ...
  const columnDefs = [
    ...
    { headerName: 'Expired Date', field: 'expire_date', editable: true, filter: true, cellStyle: { textAlign: 'left' }, hide: !showColumns['expire_date'] },
  ...
  useEffect(() => {
    fetchData('/getAllItemsexpired/' + outlet_id + '/3/100', setCategoryData, setError, setIsLoading);
  }, []);
