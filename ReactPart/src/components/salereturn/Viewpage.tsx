...
const Viewpage: React.FC = () => {
  ...
  const outlet_id = localStorage.getItem('outlet_id');
    ...
    useEffect(() => {
    fetchData('/getAllReturnOutletwise/'+outlet_id, setCategoryData, setError, setIsLoading);
    ...
    {categoryData && categoryData.list && categoryData.list.map((category: any) => (
      ...
      <tr key={category.id} className="whitespace-nowrap">
        <td className="px-6 py-4 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
         ...
         <div className="flex flex-col gap-4 sm:flex-row sm:items-center items-center"><p className="text-sm text-black dark:text-white">{category.return_code}</p></div>
        </td>
     
        <td className="px-6 py-4 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
        
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center items-center"><p className="text-sm text-black dark:text-white">{category.return_date}&nbsp; {category.created_time}</p></div>
       </td>
       <td className="px-6 py-4 text-xs sm:text-sm md:text-sm lg:text-sm xl:text-sm text-gray-500 text-center">
