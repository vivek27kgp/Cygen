  ...
  return (
    ...
    <div className="relative">
      ...
      <div className="flex items-center justify-between border-b border-stroke py-4 pl-0 px-6.5 dark:border-strokedark">
        ...
        <button onClick={toggleExpansion_four} className="focus:outline-none">
          {isExpanded_four ? (
            <svg
      ...
      <div className={`rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${isExpanded_four ? 'block' : 'hidden'}`}>
        <div className="p-6.5">
          {/* Product Information */}
...
export default Productinformation4;
