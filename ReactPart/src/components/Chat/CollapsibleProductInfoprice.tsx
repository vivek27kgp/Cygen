...
function CollapsibleProductInfoprice() {
  ...
  return (
    ...
    <div className="relative">
      ...
      <div className="flex items-center justify-between border-b border-stroke py-4  pl-0 px-6.5 dark:border-strokedark">
        ...
        <button onClick={toggleExpansion_two} className="focus:outline-none">
          {isExpanded_two ? (
            <svg
      ...
      <div className={`rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark ${isExpanded_two ? 'block' : 'hidden'}`}>
        <div className="p-6.5">
        ...
        <select  className={`relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-2 px-1 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary ${
...
export default CollapsibleProductInfoprice;
