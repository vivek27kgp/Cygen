...
const Productpageexpired: React.FC = () => {
    const [isPopupOpen, setIsPopupOpen] = useState(false);
    const columns = ['Product Name', 'Barcode', 'Expired Date', 'Category', 'Brand', 'Unit', 'Purchase Price', 'Sales Price', 'TAX', 'Status', 'Display Device'];
...
export default Productpageexpired;
